...
<div class="container">
	<h2 class="title-page" style="    color: #fff;
    font-family: GT America;
    text-transform: uppercase;
    font-size: 16px;">My account</h2>
</div> <!-- container //  -->
</section>
<!-- ========================= SECTION INTRO END// ========================= -->
...
<div class="row">
	<aside class="col-md-3">
		<ul class="list-group">
			...
			<a class="list-group-item" href="#"> My Account details </a>
		</ul>
	</aside> <!-- col.// -->
	<main class="col-md-9">
		...
		<article class="card mb-3">
			<div class="card-body">
				...
				<figure class="icontext">
						<div class="icon">
							<img class="rounded-circle img-sm border" src="{{asset('images/avatars/photo.jpg')}}">
						</div>
						<div class="text">
							<strong> 
								...
								@else 
									Mrs. 
								@endif {{Auth::user()->last_name}} {{Auth::user()->first_name}}</strong> <br> 
							{{Auth::user()->email}} <br> 
							<a href="#">Edit</a>
						</div>
				</figure>
		...
		<article class="card  mb-3">
			...
			<a href="#" class="btn btn-outline-primary all_order_btn"> See all orders  </a>
			</div> <!-- card-body .// -->
		</article> <!-- card.// -->
